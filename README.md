...
## 📁 Projects
- **simpleWeb/** – Basic PHP website, runs directly in a browser.
- **simpleContact/** – Contact form built with PHP, runs directly in a browser.
- **final_project/** – A complete PHP application using MySQL.
